...
import { loginUser, signUpUser, loginWithGoogle } from '../services/firebaseAuth';
                ...
                <div className="max-w-md w-full mx-auto">
                    ...
                    <div className="mb-10 text-center lg:text-left">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 font-medium">
                            {isLogin ? "Please enter your details to sign in" : "Join our community and start your journey"}
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {isLogin && (
                            <div className="flex items-center justify-between py-1">
                                ...
                                <a href="#" className="text-sm font-bold text-primary hover:text-teal-700 transition-colors">Forgot Password?</a>
                            </div>
                        )}
                        ...
                        >
                            <span className="relative z-10">{loading ? "Processing..." : isLogin ? "Log In" : "Create Account"}</span>
